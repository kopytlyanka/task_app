...
class _BranchState extends State<Branch> {
  ...
  AppBar _createAppBar() {
    ...
    var options = [
      _createMenuItem(
        notifier.isUnchecked ? 'Показать выполненные' : 'Скрыть выполненные',
        () => setState(() => notifier.toggleUnchecked()),
        notifier.isUnchecked ? Icon(Icons.check_circle_outline, color: theme) : Icon(Icons.check_circle, color: theme),
      ),
      _createMenuItem(
        notifier.isOnlyFavorite ? 'Показать все' : 'Только избранные',
        () => setState(() => notifier.toggleOnlyFavorite()),
        notifier.isOnlyFavorite ? Icon(Icons.star_border, color: theme) : Icon(Icons.star, color: theme),
      ),
